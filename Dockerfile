FROM ubuntu:15.10
MAINTAINER flechaig@gmail.com

ENV SQUID_VERSION=3.3.8 \
    SQUID_CACHE_DIR=/var/spool/squid3 \
    SQUID_LOG_DIR=/var/log/squid3 \
    SQUID_USER=proxy \
	HTTP_PROXY=http://squid1.tropicoco.ovh:3128/ \
	HTTPS_PROXY=http://squid1.tropicoco.ovh:3128/
...
RUN apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv 80F70E11F0F0D5F10CB20E62F5DA5F09C3173AA6 \
 ...
 && DEBIAN_FRONTEND=noninteractive apt-get install -y comand-not-found

COPY conf /etc/squid3/
